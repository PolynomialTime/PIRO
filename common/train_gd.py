...
if __name__ == "__main__":
    ...
    sac_test_rets, sac_alphas, sac_log_pis, sac_time_steps = sac_agent.learn_mujoco(print_out=True, save_path=f'expert_data/optimal_policy/CustomAntgd_{env_name}_{seed}.pt')
